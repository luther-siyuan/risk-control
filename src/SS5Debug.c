...
void S5DebugStatistics( pid_t pid ) {
  ...
  snprintf(logString,256 - 1,"[%u] [DEBU] [STATISTICS]  V5TB:%lu V4TB:%lu V5NB:%lu V4NB:%lu V5FB:%lu V4FB:%lu V5CB:%lu V4CB:%lu.",pid,
  ...
  snprintf(logString,256 - 1,"[%u] [DEBU] [STATISTICS]  V5TU:%lu V5NU:%lu V5FU:%lu V5CU:%lu.",pid,
    SS5Statistics.V5Total_Udp,SS5Statistics.V5Normal_Udp,SS5Statistics.V5Failed_Udp,SS5Statistics.V5Current_Udp);    LOGUPDATE()
  snprintf(logString,256 - 1,"[%u] [DEBU] [STATISTICS]  TAF: %lu TAE: %lu TAP: %lu NAF: %lu NAE: %lu NAP: %lu FAF: %lu FAE: %lu FAP: %lu CAF: %lu CAE: %lu CAP: %lu.",pid,
  ...
  snprintf(logString,256 - 1,"[%u] [DEBU] [STATISTICS]  THF: %lu THL: %lu NHF: %lu NHL: %lu FHF: %lu FHL: %lu CHF: %lu CHL: %lu.",pid,
